...
<div id="wrapper"> 
  ...
  <div id="content" class="container_12">
    ...
    <div id="checkout" class="grid_12">
    	<form id="checkout_form" class="s_accordion" action="/myshop/order/save">
        ...
        <div>
          ...
          <div class="grid_6 omega">
            ...
            <div class="s_row_2 clearfix">
              <label>Address: *</label>
              <input name = "address" type="text" size="30" class="required" title="Address 1 must be between 3 and 128 characters!" />
            </div>
