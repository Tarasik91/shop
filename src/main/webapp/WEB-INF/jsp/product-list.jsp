				...
				<tbody>
					<c:forEach items="${products}" var="product">
						<tr>
							...
							<td><a class="waves-effect waves-light btn btn-small"
								href="/myshop/admin/product/edit/<c:out value="${product.id}" />">edit</a>
								<a class="waves-effect waves-light btn btn-small"
								href="/myshop/admin/product/delete/<c:out value="${product.id}" />">delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
